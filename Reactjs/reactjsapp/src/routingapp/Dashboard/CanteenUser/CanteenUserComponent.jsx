...
import ResuableTable from "../../Dashboard/ReusableComponent/ReusableTable";

class CanteenUserComponent extends Component {
  constructor(props) {
    super(props);
    this.state = {
      Canteendetails: [],
      ...
      <div>
        <center>
          ...
          <div className="topnav">
            <Link to="/CanteenUserDashboard">Dashboard</Link>
            <Link to="/CreateCanteenUser">New Bill</Link>
          ...
          <div className="container">
            <center>
              <ResuableTable
                dataSource={this.state.Canteendetails}
                Id={"Order_id"}
                showdata={this.state.deletebutton}
                route={"EditCanteenUser"}
                btnEdit={"Edit"}
                routeDischarge={"DeleteCanteenUser"}
...
export default CanteenUserComponent;
