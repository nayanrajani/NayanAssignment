...
class WardboyComponent extends Component {
  constructor(props) {
    ...
    // this.state.columnHeaders = Object.keys(this.state.WardBoyDetails[0]);
  ...
  getWardBoyValues() {
    ...
    if (token == undefined || user == undefined || CurrentRole == undefined) {
      ...
      this.serv
        ...
        .then((resp) => {
          this.setState({ WardBoyDetails: resp.data.message });
          this.setState({ message: `Data Fetched!!` });
          this.setState(
            { columnHeaders: Object.keys(this.state.WardBoyDetails[0]) },
            () => {
      ...
      <div>
        <center>
          ...
          <div className="container">
            <center>
              <ResuableTable
                dataSource={this.state.WardBoyDetails}
                Id={"Wardboy_id"}
                showdata={this.state.deletebutton}
                route={"EditWardBoy"}
                btnEdit={"Edit"}
                routeDischarge={"DeleteWardBoyData"}
          ...
          {/* <div className="container">
            <table className="table table-bordered table-striped table-dark">
              ...
              <tbody>
                {this.state.WardBoyDetails.map((dept, idx) => (
                  <tr key={idx}>
