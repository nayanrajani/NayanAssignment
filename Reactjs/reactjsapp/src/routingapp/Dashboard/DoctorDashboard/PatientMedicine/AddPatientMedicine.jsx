...
class AddPatientmedicine extends Component {
  constructor(props) {
    super(props);
    this.state = {
      Patient_id: "",
  ...
  save = () => {
    ...
    if (
      ...
      this.serv
        .AddpatientmedicineData(Patient)
        .then((resp) => {
      ...
      <div className="container">
        ...
        <form>
          ...
          <div className>
            ...
            <DropDownComponent
              dataSource={this.state.Medicinecall}
              stateProperty={this.state.DropMedicine}
              selectedValue={this.MedicineDropdownSelected.bind(this)}
            ></DropDownComponent>
          </div>
          <div className="form-group">
              <label hidden={true} htmlFor="Medicine_price">
              Medicine Price
              </label>
              <input
                hidden={true}
...
export default AddPatientmedicine;
