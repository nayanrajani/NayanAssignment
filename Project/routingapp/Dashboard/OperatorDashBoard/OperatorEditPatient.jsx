...
class OperatorEditPatient extends Component {
  constructor(props) {
    super(props);
    this.state = {
      Patient_id: "",
    ...
    if (token === undefined) {
      ...
      this.serv
        ...
        .then((resp) => {
          ...
          this.setState({ DoctorRecall: Patient.Doctor_Name });
        })
        .catch((error) => {
  ...
  save = () => {
    ...
    if (
      ...
      let Patient = {
        ...
        Doctor_Name: this.state.DoctorRecall,
      };
    ...
    return (
      <div className="container">
        ...
        <form>
          ...
          <div className="form-group">
            <label htmlFor="Patient_Email">Patient_Email</label>
            <input
              type="email"
              name="Patient_Email"
              className="form-control"
            ...
            />
            <div className="form-group">
              <label htmlFor="Patient_Age">Patient_Age</label>
              <input
                type="number"
                name="Patient_Age"
                className="form-control"
            ...
            {/* <div className="form-group">
              <label htmlFor="Patient_Gender">Patient_Gender</label>
              <input
                type="text"
                name="Patient_Gender"
                className="form-control"
            ...
            <div className="form-group">
              <label htmlFor="Patient_Address">Patient_Address</label>
              <input
                type="text"
            ...
            <div className="form-group">
              <label htmlFor="Patient_Phoneno">Patient_Phoneno</label>
              <input
                type="number"
            ...
            <div className="form-group">
              <label htmlFor="Patient_Addhaar">Patient_Addhaar</label>
              <input
                type="number"
            ...
            {/* <div className="form-group">
              <label htmlFor="Patient_Disease">Patient_Disease</label>
              <input
                type="text"
            ...
            {/* <div className="form-group">
              <label htmlFor="Patient_Ward_type">Patient_Ward_type</label>
              <input
                type="text"
                name="Patient_Ward_type"
                className="form-control"
                value={this.state.Patient_Ward_type}
                onChange={this.handleAllChanges.bind(this)}
              />
            </div> */}
            <div className>
              <label>Patient_Ward_type*</label>
              <DropDownComponent
            ...
            {/* <div className="form-group">
              <label htmlFor="Patient_Room_no">Patient_Room_no</label>
              <input
                type="text"
...
export default OperatorEditPatient;
