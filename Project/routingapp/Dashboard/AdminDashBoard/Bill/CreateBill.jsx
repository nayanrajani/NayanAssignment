    ...
    return (
      <div className="container">
        ...
        <form>
          ...
          <div className="text-danger">{this.state.errors.Patient_id}</div>
          <div className="form-group">
          ...
          <div className="text-danger">{this.state.errors.Doctor_id}</div>
          <div className="form-group">
          ...
          <div className="form-group">
            <label htmlFor="no_of_days">no_of_days</label>
            <input
              type="number"
              name="no_of_days"
              className="form-control"
          ...
          <div className="text-danger">{this.state.errors.no_of_days}</div>
          <div className="form-group">
            <label htmlFor="otherlabcharge">otherlabcharge</label>
            <input
              type="number"
              name="otherlabcharge"
              className="form-control"
          ...
          <div className="text-danger">{this.state.errors.otherlabcharge}</div>
          <div className="form-group">
            <label htmlFor="Bill_Total">Bill_Total</label>
            <input
              type="number"
              name="Bill_Total"
              className="form-control"
          ...
          <div className="text-danger">{this.state.errors.Bill_Total}</div>
