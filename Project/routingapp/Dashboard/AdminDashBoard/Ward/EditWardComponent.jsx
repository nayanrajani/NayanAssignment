      ...
      <div className="container">
        ...
        <form>
          <div className="form-group">
            <label htmlFor="Ward_no">Ward_no</label>
            <input
              type="number"
              name="Ward_no"
          ...
          <div className="form-group">
            <label htmlFor="Ward_Type">Ward_Type</label>
            <input
              type="text"
              name="Ward_Type"
              className="form-control"
          ...
          <div className="text-danger">{this.state.errors.Ward_Type}</div>

          <div className="form-group">
            <label htmlFor="Ward_Contact">Ward_Contact</label>
            <input
              type="email"
              name="Ward_Contact"
              className="form-control"
          ...
          <div className="text-danger">{this.state.errors.Ward_Contact}</div>
