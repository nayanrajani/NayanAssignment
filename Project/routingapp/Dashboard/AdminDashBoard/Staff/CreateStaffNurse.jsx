...
class CreateStaffNurse extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  save = () => {
    ...
    if (this.state.Nurse_salary === "" || this.state.Nurse_salary === 0) {
      ...
      let staffNurse = {
        ...
        Staff_Name: this.state.Nurse_Name,
        Staff_Email: this.state.Nurse_Email,
        Staff_Age: this.state.Nurse_Age,
        Staff_Gender: this.state.GenderCall,
        Staff_Address: this.state.Nurse_Address,
        Staff_Phoneno: this.state.Nurse_Phoneno,
        Staff_Addhaar: this.state.Nurse_Addhaar,
        Staff_Salary: this.state.Nurse_salary,
      };
      this.serv
        .AddStaffData(staffNurse)
        .then((resp) => {
      ...
      <div className="container">
        ...
        <form>
          <div className="form-group">
            <label htmlFor="Nurse_Name">Nurse_Name</label>
            <input
              type="text"
              name="Nurse_Name"
          ...
          <div className="text-danger">{this.state.errors.Nurse_Name}</div>

          <div className="form-group">
            <label htmlFor="Nurse_Email">Nurse_Email</label>
            <input
              type="email"
              name="Nurse_Email"
              className="form-control"
          ...
          <div className="form-group">
            <label htmlFor="Nurse_Age">Nurse_Age</label>
            <input
              type="number"
              name="Nurse_Age"
              className="form-control"
          ...
          <div className="text-danger">{this.state.errors.Nurse_Age}</div>

          {/* <div className="form-group">
            <label htmlFor="Nurse_Gender">Nurse_Gender</label>
            <input
              type="text"
              name="Nurse_Gender"
              className="form-control"
              value={this.state.Nurse_Gender}
              onChange={this.handleAllChanges.bind(this)}
            />
          </div> */}
          <div className="form-group">
            <label>Nurse_Gender</label>
            <DropDownComponent
          ...
          <div className="text-danger">{this.state.errors.Nurse_Gender}</div>

          <div className="form-group">
            <label htmlFor="Nurse_Address">Nurse_Address</label>
            <input
              type="text"
              name="Nurse_Address"
              className="form-control"
          ...
          <div className="text-danger">{this.state.errors.Nurse_Address}</div>

          <div className="form-group">
            <label htmlFor="Nurse_Phoneno">Nurse_Phoneno</label>
            <input
              type="number"
              name="Nurse_Phoneno"
              className="form-control"
          ...
          <div className="text-danger">{this.state.errors.Nurse_Phoneno}</div>

          <div className="form-group">
            <label htmlFor="Nurse_Addhaar">Nurse_Addhaar</label>
            <input
              type="number"
              name="Nurse_Addhaar"
              className="form-control"
          ...
          {/* <div className="form-group">
            <label htmlFor="Nurse_Room">Nurse_Room</label>
            <input
              type="text"
              name="Nurse_Room"
              className="form-control"
              value={this.state.Nurse_Room}
              onChange={this.handleAllChanges.bind(this)}
            />
          </div> */}
          <div className>
            <label>Nurse_Room*</label>
            <DropDownComponent
          ...
          <div className="text-danger">{this.state.errors.Nurse_Room}</div>

          <div className="form-group">
            <label htmlFor="Nurse_salary">Nurse_salary</label>
            <input
              type="text"
              name="Nurse_salary"
              className="form-control"
          ...
          <div className="text-danger">{this.state.errors.Nurse_salary}</div>
...
export default CreateStaffNurse;
