...
class CreateStaffDoctor extends Component {
  constructor(props) {
    super(props);
    this.state = {
      Staff_Designation: "Doctor",
      //   Patient_id: "",
      Doctor_id: "",
      Doctor_Name: "",
      Doctor_Email: "",
  ...
  save = () => {
    ...
    if (this.state.Doctor_Charges === "" || this.state.Doctor_Charges === 0) {
      ...
      let staffDoctor = {
        ...
        Staff_Name: this.state.Doctor_Name,
        Staff_Email: this.state.Doctor_Email,
        Staff_Age: this.state.Doctor_Age,
        Staff_Gender: this.state.GenderCall,
        Staff_Address: this.state.Doctor_Address,
        Staff_Phoneno: this.state.Doctor_Phoneno,
        Staff_Addhaar: this.state.Doctor_Addhaar,
        Staff_Salary: this.state.Doctor_Charges,
      };
      this.serv
        .AddStaffData(staffDoctor)
        .then((resp) => {
